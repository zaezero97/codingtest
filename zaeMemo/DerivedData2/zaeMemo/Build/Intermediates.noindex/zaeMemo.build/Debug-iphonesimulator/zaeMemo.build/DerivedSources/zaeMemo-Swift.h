...
#ifndef ZAEMEMO_SWIFT_H
#define ZAEMEMO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="zaeMemo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7zaeMemo11AppDelegate")
...
@interface Folder (SWIFT_EXTENSION(zaeMemo))
- (void)addNewRelationshipObject:(Memo * _Nonnull)value;
- (void)removeNewRelationshipObject:(Memo * _Nonnull)value;
- (void)addNewRelationship:(NSSet * _Nonnull)values;
- (void)removeNewRelationship:(NSSet * _Nonnull)values;
@end

@class NSString;

@interface Folder (SWIFT_EXTENSION(zaeMemo))
@property (nonatomic) int16_t child_fds;
@property (nonatomic) int16_t id;
@property (nonatomic, copy) NSString * _Nullable name;
@property (nonatomic, strong) NSSet * _Nullable newRelationship;
@end
...
SWIFT_CLASS("_TtC7zaeMemo20FolderViewController")
...
@interface FolderViewController (SWIFT_EXTENSION(zaeMemo)) <UITableViewDataSource>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


@interface FolderViewController (SWIFT_EXTENSION(zaeMemo))
- (void)goWrite;
...
@interface FolderViewController (SWIFT_EXTENSION(zaeMemo)) <UITableViewDelegate>
...
@interface Memo (SWIFT_EXTENSION(zaeMemo))
...
@property (nonatomic, strong) Folder * _Nullable newRelationship;
@end

@class UIWindow;
@class UIScene;

SWIFT_CLASS("_TtC7zaeMemo13SceneDelegate")
...
SWIFT_CLASS("_TtC7zaeMemo19WriteViewController")
@interface WriteViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified curDateLabel;
@property (nonatomic, weak) IBOutlet UIToolbar * _Null_unspecified bottomToolBar;
...
@interface WriteViewController (SWIFT_EXTENSION(zaeMemo))
- (void)save;
@end
...
@interface WriteViewController (SWIFT_EXTENSION(zaeMemo)) <UITextFieldDelegate>
@end
